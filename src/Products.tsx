    ...
    return(
          ...
          <div className="ss_container text_center">
            ...
            <div className="rows midrows">
              ...
              <div className="cols-70">
                <p>HTML Static Template, Editable template, HTML 5, CSS3, SCSS, jQuery, Bootstrap 4.0, Editable Logo PSD and other images PSD. Responsive modals, Ready-made editable stylesheets. Healthcare mockup theory from Indian Health Guru his very own beginner website. This Medical website is for all over India, publish worldwide, brings patients from worldwide for surgery.</p>
        ...
        <section className="Snew_mn2" id="quotes">
          <div className="ss_container text_center">
            ...
            <p>Read more for the various plans by <span style={{display: "inline-block"}}><a href="https://www.adobe.com/in/creativecloud/plans.html" target="_blank" className="acc" rel="noreferrer nofollow"><img src={require('./images/card-img.png')} width="154" height="150" style={{width: "32px", height: "auto"}} alt="Adobe Creative Cloud" />Adobe Creative Cloud</a></span></p>
